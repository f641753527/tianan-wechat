<template>
  <div>
    ...
    <mt-button type="danger" @click.native="booking" size="small" v-if="formType !== 2" class="myButton">申 请</mt-button>
  ...
  methods: {
    ...
    getInfo() {  // 获取详情
      ...
      this.$http.post(`${this.URL_PREFIX}/app/get/park/service/form/tree`, {
        ...
        serviceId: this.$route.params.serviceId ? this.$route.params.serviceId : 1001,
      }, {
