<template>
  <div class='job-detail'>
    ...
    <mt-cell class='job_desc' title="职责描述"></mt-cell>
...
export default {
  ...
  methods: {
    ...
    submitRequest() {
      this.$http.post(`${this.URL_PREFIX}/app/added/hr/service/order`, {
    ...
    getJobDetail() {
      this.$http.post(`${this.URL_PREFIX}/app/get/hr/service/info/detail`, {
        id: this.jobId,
      }, {
        headers: { token: this.token, }
      }).then((response) => {
